...
|------|-------------|------|---------|:--------:|
| <a name="input_concurrent_reconciles"></a> [concurrent\_reconciles](#input\_concurrent\_reconciles) | The number of concurrent reconciles the External Secrets Operator controller can do. | `number` | `1` | no |

...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_eso_namespace"></a> [eso\_namespace](#module\_eso\_namespace) | git::https://github.com/terraform-ibm-modules/terraform-ibm-namespace.git | k8s_v3 |
...
| <a name="input_reloader_chart_version"></a> [reloader\_chart\_version](#input\_reloader\_chart\_version) | The version of the Reloader Helm chart. Ensure that the chart version is compatible with the image version specified in reloader\_image\_version. | `string` | `"2.2.5"` | no |

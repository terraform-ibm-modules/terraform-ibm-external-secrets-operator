...
| <a name="input_reloader_image"></a> [reloader\_image](#input\_reloader\_image) | The reloader image in the format of `[registry-url]/[namespace]/[image]`. | `string` | `"stakater/reloader"` | no |
...
| <a name="input_reloader_repository"></a> [reloader\_repository](#input\_reloader\_repository) | The reloader image repository in the format of `[registry-url]/[namespace]/[image]`. | `string` | `"ghcr.io/stakater/reloader"` | no |

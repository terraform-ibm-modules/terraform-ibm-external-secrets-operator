...
variable "reloader_image_version" {
  ...
  default     = "v1.4.7-ubi@sha256:664864220e594e5a66e9ef1e772a52d71bdb594ba36f849606177eeed573f031" # datasource: ghcr.io/stakater/reloader
  nullable    = false
  validation {
...
variable "reloader_chart_version" {
  ...
  default     = "2.2.2" # registryUrl: stakater.github.io/stakater-charts
  nullable    = false
}

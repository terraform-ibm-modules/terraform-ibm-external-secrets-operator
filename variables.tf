...
variable "reloader_image_version" {
  ...
  default     = "v1.4.11-ubi@sha256:75fa9e2dd58829d4585dc9ecb3d866eb80ba19128f02aa7921f18dd2aa3ee4f4" # datasource: ghcr.io/stakater/reloader
  nullable    = false
  validation {
...
variable "reloader_chart_version" {
  ...
  default     = "2.2.6" # registryUrl: stakater.github.io/stakater-charts
  nullable    = false
}

...
variable "eso_chart_version" {
  ...
  default     = "0.18.2" # registryUrl: charts.external-secrets.io
  nullable    = false
}
...
variable "reloader_image_version" {
  ...
  default     = "v1.4.5-ubi@sha256:62c24d145b95cc18d51de5c6402c770994600d3a0692ea1cc365ffd11564a884" # datasource: ghcr.io/stakater/reloader
  nullable    = false
  validation {
...
variable "reloader_chart_version" {
  ...
  default     = "2.1.5" # registryUrl: stakater.github.io/stakater-charts
  nullable    = false
}

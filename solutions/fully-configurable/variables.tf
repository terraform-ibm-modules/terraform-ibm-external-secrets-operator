...
variable "eso_image_version" {
  ...
  default     = "v1.2.0-ubi@sha256:90b1fcf5c8679513f1485612bab3e53a94eb3c8865f2e69b73e5c3d80ae49088" # datasource: ghcr.io/external-secrets/external-secrets
  nullable    = false
  validation {
...
variable "eso_chart_version" {
  ...
  default     = "1.2.0" # registryUrl: charts.external-secrets.io
  nullable    = false
}

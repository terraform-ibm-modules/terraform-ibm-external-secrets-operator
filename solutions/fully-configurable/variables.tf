...
variable "eso_image_version" {
  ...
  default     = "v2.4.1-ubi@sha256:e3d910391350a527b353faf351ed395d570cd0f7af357ba2870f3b1ba58567d4" # datasource: ghcr.io/external-secrets/external-secrets
  nullable    = false
  validation {
...
variable "eso_chart_version" {
  ...
  default     = "2.4.1" # registryUrl: charts.external-secrets.io
  nullable    = false
}

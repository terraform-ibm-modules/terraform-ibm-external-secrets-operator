...
module "eso_clusterstore" {
  source                            = "http://registry.terraform.io/modules/terraform-ibm-modules/external-secrets-operator/ibm/latest/submodules/eso-clusterstore"
...
module "external_secret_usr_pass" {
  ...
  source                    = "http://registry.terraform.io/modules/terraform-ibm-modules/external-secrets-operator/ibm/latest/submodules/eso-external-secret"
